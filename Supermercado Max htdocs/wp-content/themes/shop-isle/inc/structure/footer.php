		...
		<footer class="footer bg-dark">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="mapa_sitio col-sm-6">
						<li><a href="http://localhost/categoria-producto/alimentos/">Alimentos</a></li>
						<li><a href="http://localhost/categoria-producto/electrodomesticos/">Electrodomesticos</a></li>
						<li><a href="http://localhost/categoria-producto/muebles/">Muebles</a></li>
						<li><a href="http://localhost/categoria-producto/utensilios-de-limpieza/">Utensilios De Limpieza</a></li>
						<li><a href="http://localhost/nosotros/">Nosotros</a></li>
					</div>
					...
					if ( isset( $shop_isle_site_info_hide ) && $shop_isle_site_info_hide != 1 ) {
						echo apply_filters( 'shop_isle_site_info','<p class="shop-isle-poweredby-box"><a class="shop-isle-poweredby" href="http://themeisle.com/themes/shop-isle/" rel="nofollow"> Estudiante </a>' . __( 'De','shop-isle' ) . '<a class="shop-isle-poweredby" href="http://nextu.com/" rel="nofollow"> Next_U</a></p>' );
					}
					echo '</div>';
